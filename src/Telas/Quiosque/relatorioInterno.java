...
public class relatorioInterno extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Relatório Interno");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(relatorioInterno.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new relatorioInterno().setVisible(true);
            }
        });
    }
